...
namespace Peak.Can.Light
{
  public class PCAN_2PCC
  {
    ...
    public static extern uint Write(ref PCAN_2PCC.TPCANMsg msg);

    [DllImport("PCAN_2PCC.dll", EntryPoint = "CAN2_Read")]
    public static extern uint Read(out PCAN_2PCC.TPCANMsg msg);

    [DllImport("PCAN_2PCC.dll", EntryPoint = "CAN2_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_2PCC.TPCANMsg msg,
      out PCAN_2PCC.TPCANTimestamp timestamp);
