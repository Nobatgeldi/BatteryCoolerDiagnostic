...
namespace Peak.Can.Light
{
  public class PCAN_PCI
  {
    ...
    public static extern uint Write(ref PCAN_PCI.TPCANMsg msg);

    [DllImport("PCAN_PCI.dll", EntryPoint = "CAN_Read")]
    public static extern uint Read(out PCAN_PCI.TPCANMsg msg);

    [DllImport("PCAN_PCI.dll", EntryPoint = "CAN_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_PCI.TPCANMsg msg,
      out PCAN_PCI.TPCANTimestamp timestamp);
