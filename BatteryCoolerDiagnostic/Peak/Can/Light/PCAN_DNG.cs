...
namespace Peak.Can.Light
{
  ...
  {
    public const int HW_DONGLE_SJA = 5;
    public const int HW_DONGLE_SJA_EPP = 6;
    ...
    public static extern uint Write(ref PCAN_DNG.TPCANMsg msg);

    [DllImport("PCAN_DNG.dll", EntryPoint = "CAN_Read")]
    public static extern uint Read(out PCAN_DNG.TPCANMsg msg);

    [DllImport("PCAN_DNG.dll", EntryPoint = "CAN_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_DNG.TPCANMsg msg,
      out PCAN_DNG.TPCANTimestamp timestamp);
