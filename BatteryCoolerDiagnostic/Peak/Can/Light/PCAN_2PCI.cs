...
namespace Peak.Can.Light
{
  public class PCAN_2PCI
  {
    ...
    public static extern uint Write(ref PCAN_2PCI.TPCANMsg msg);

    [DllImport("PCAN_2PCI.dll", EntryPoint = "CAN2_Read")]
    public static extern uint Read(out PCAN_2PCI.TPCANMsg msg);

    [DllImport("PCAN_2PCI.dll", EntryPoint = "CAN2_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_2PCI.TPCANMsg msg,
      out PCAN_2PCI.TPCANTimestamp timestamp);
