...
namespace Peak.Can.Light
{
  public class PCAN_2ISA
  {
    ...
    public static extern uint Write(ref PCAN_2ISA.TPCANMsg msg);

    [DllImport("PCAN_2ISA.dll", EntryPoint = "CAN2_Read")]
    public static extern uint Read(out PCAN_2ISA.TPCANMsg msg);

    [DllImport("PCAN_2ISA.dll", EntryPoint = "CAN2_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_2ISA.TPCANMsg msg,
      out PCAN_2ISA.TPCANTimestamp timestamp);
