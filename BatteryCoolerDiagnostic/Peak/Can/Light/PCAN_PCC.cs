...
namespace Peak.Can.Light
{
  public class PCAN_PCC
  {
    ...
    public static extern uint Write(ref PCAN_PCC.TPCANMsg msg);

    [DllImport("PCAN_PCC.dll", EntryPoint = "CAN_Read")]
    public static extern uint Read(out PCAN_PCC.TPCANMsg msg);

    [DllImport("PCAN_PCC.dll", EntryPoint = "CAN_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_PCC.TPCANMsg msg,
      out PCAN_PCC.TPCANTimestamp timestamp);
