...
namespace Peak.Can.Light
{
  public class PCAN_USB
  {
    ...
    public static extern uint Write(ref PCAN_USB.TPCANMsg msg);

    [DllImport("PCAN_USB.dll", EntryPoint = "CAN_Read")]
    public static extern uint Read(out PCAN_USB.TPCANMsg msg);

    [DllImport("PCAN_USB.dll", EntryPoint = "CAN_ReadEx")]
    public static extern uint ReadEx(
      out PCAN_USB.TPCANMsg msg,
      out PCAN_USB.TPCANTimestamp timestamp);
